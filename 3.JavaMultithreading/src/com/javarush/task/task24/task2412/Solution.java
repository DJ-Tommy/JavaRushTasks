...
public class Solution {
    public static void main(String[] args) {
        System.out.println("asdf".compareTo("asfd"));
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                listNames.add((String)stock1.get("name"));
                listNames.add((String)stock2.get("name"));
                int dateCompare = ((Date)stock1.get("date")).compareTo((Date)stock2.get("date"));
                if (listNames.get(0).equals(listNames.get(1))) {
                ...
                if (listNames.get(0).equals(stock1.get("name"))) {
                    return -1;
                }
                return 1;
            }
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Applied Materials, Inc.", "AMAT", -.26, getRandomDate()));
        stocks.add(new Stock("Fake Applied Materials, Inc.", "AMAT", .25, (Date)stocks.get(stocks.size() - 1).get("date")));
